...
import { AreaOption, CategoryOption, SharedProps } from '@/types';
...
export default function Create({ categories, areas }: Props) {
    ...
    return (
        <main className="mx-auto max-w-xl p-6 font-sans">
            <Head title="Post a Request" />
            <h1 className="mb-4 text-2xl font-semibold text-gray-900">Post a Request</h1>
            ...
            <form onSubmit={submit} className="flex flex-col gap-4">
                ...
                <div>
                    ...
                    <p className="mt-1 text-xs text-gray-500">
                        Photos with location or other identifying metadata are automatically stripped before saving.
                        Please avoid photos that show your exact address, faces, room numbers, or vehicle plates.
                    </p>
                </div>
